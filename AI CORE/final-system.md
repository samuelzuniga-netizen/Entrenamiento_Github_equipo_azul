### PROBLEMA
El sistema de la ciudad debe integrarlo todo.
...
Sistema de sensores
- Si movimiento es si, y luz no 
    --> actividad sospechosa
- Si luz no, y ruido bajo
    --> no actividad sospechosa
- Si movimiento es si, y ruido bajo 
    --> actividad sospechosa

Sistema de rutas 
- Mientras va pasando el dia, el trafico va bajando.
